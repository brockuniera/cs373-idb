...
def fill_restaurant_data(restaurant, restaurant_data) :
    ...
    #restaurant_data['catlist'] = restaurant.categories
...
def main():
    ...
    while(params['offset'] < 10):
        ...
        for restaurant in restaurant_response.businesses:
            ...
            # locModel.restaurant = restModel # Backpopulated so you don't have to do this line!
	...
	for category in category_data:
            ...
            # Print restaurants
            for rest in catModel.restlist:
                #print("Restname: '{}', List:'{}'".format(rest.name, [i.name for i in rest.catlist]))
                pass
